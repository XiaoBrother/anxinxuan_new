...
public class XRTextView extends TextView{
	 ...
	 private float LineSpacing = 1.6f;//行与行的间距
	 
	 public XRTextView(Context context, AttributeSet attrs) {
	  super(context, attrs);
	  text = attrs.getAttributeValue(
	    "http://schemas.android.com/apk/res/android", "text");
	  textSize = attrs.getAttributeIntValue(namespace, "xrTextSize", 17);//字体大小
 	  textSize=DensityUtil.sp2px(textSize);
	  textColor = attrs.getAttributeIntValue(namespace, "xrTextColor",Color.BLUE);//字体颜色
